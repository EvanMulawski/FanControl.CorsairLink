...
| Hydro H150i Pro XT             | `0c22`     | HydroPlatinum  | Full Support <sup>1,2</sup>       | ✅                                | ✅ <sup>4</sup>                   | ✅ <sup>5</sup>                   |
...
| `FANCONTROL_CORSAIRLINK_LOG_FILE_DISABLED` <sup>3</sup>                   | Disables all logging to the `CorsairLink.log` file.            | `1` = disabled, `0` = enabled               |
